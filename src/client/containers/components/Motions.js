    ...
    return (
      <div style={{ textAlign: "left" }}>
        <Select
          ...
          onChange={e => this.setState({ delegation: e.value })}
        />
        <RadioGroup
          value={sessionType}
              ...
              onClick={() => {
                ...
                switch (sessionType) {
                  case "mod":
                    ...
                    setSession("Moderated Caucus");
                    break;
                  case "unmod":
                    changeState("unmoderated", stateData);
                    setSession("Unmoderated Caucus");
                    break;
                }
              }}
              variant="fab"
