...
import {AppBar, Toolbar, Icon, Grid, Card, CardContent, CardActions, Typography, Button} from "@material-ui/core";

const Info = ({history}) => {
  const redirectLogin = () => history.push("/login");
  const openGithub = () => window.open("https://github.com/chen-robert/blob-mun");
  return (
    ...
    >
      ...
      >
        <Grid item xs={3} md={2}>
          <div>
            ...
            <div>
              <Typography component="p" color="default">
                All your information is stored on the cloud. Even if you use two different computers, it'll all be saved. 
              </Typography>
            </div>
          </div>
        </Grid>
      ...
      >
        <Grid item xs={3} md={2}>
          <div>
            <div>
            <Typography variant="headline" component="h2" style={{color: "#d9dbdd"}}>
              Contribute
            </Typography>
            </div>
            <div>
              <Typography component="p" style={{color: "#d9dbdd"}}>
                All of our code is hosted on Github. We appreciate all contributions!
              </Typography>
            </div>
          </div>
        </Grid>
